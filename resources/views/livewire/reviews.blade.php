<div class="flex flex-col grow gap-4 justify-center items-center w-full h-full mt-27.5 select-none">
    <div class="flex flex-col gap-4 justify-center items-center h-auto w-[80%]">
        <div class="flex flex-col gap-4 justify-center items-center">
            <p>Ulasan</p>
            <h2>Terima kasih kepada semua pelanggan yang memberikan ulasan dan penilaian kepada kami.</h2>

        </div>

        <div class="grid grid-cols-3 h-auto items-center place-items-center gap-6 w-full">
            {{-- @for ($i = 0; $i < 12; $i++) --}}
