<div class="flex flex-col grow gap-4 justify-center items-center w-full h-full mt-27.5 select-none">
    <div class="flex flex-col w-[60%] my-8 h-full gap-4">
        <h1 class="text-[#8e7a5c] text-2xl font-semibold">Kebijakan Privasi</h1>
        ...
        <h2 class="text-[#8e7a5c] text-2xl font-semibold mt-4">Informasi yang Kami Kumpulkan</h2>
        <p class="text-white text-justify">
        ...
        <h2 class="text-[#8e7a5c] text-2xl font-semibold mt-4">Penggunaan Informasi</h2>
        <p class="text-white text-justify">
