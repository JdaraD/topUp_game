<div class="flex w-full h-screen">
    <div class="flex flex-none relative justify-center items-center bg-[#262727] lg:w-137.5 md:w-137.5 w-full h-full">
        ...
        <div class="flex flex-col lg:w-[80%] md:w-[80%] w-[90%] h-fit gap-4">
            <div class="flex w-full h-auto">
                @if ($profil)
                    <img src="{{ asset('storage/' .$profil->gambar)  }}" alt="" class="lg:h-16 md:h-12 h-18 py-0.5 lg:w-14 md:w-10 w-16 object-cover">
                @endif
            </div>
            <div>
                <p class="text-white text-2xl font-bold">Masuk</p>
                <p class="text-white text-sm">Masuk dengan akun yang telah Kamu daftarkan.</p>
            </div>
