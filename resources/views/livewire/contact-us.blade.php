<div class="flex flex-col grow justify-center items-center w-full h-full lg:mt-27.5 md:mt-27.5 mt-20 select-none">
    <div class="flex flex-col justify-center items-center w-full h-auto bg-[#262727] shadow-lg">
        <div class="flex flex-col w-[80%] lg:my-8 md:my-8 my-4 h-full gap-4">
            <p class="text-white lg:text-4xl md:text-4xl text-xl font-bold">Hubungi Kami</p>
            <p class="text-white lg:text-sm md:text-sm text-xs">Mengalami masalah dengan waktu transaksi? Ingin memiliki bisnis permainan kredit? Silakan hubungi kami di bawah ini sesuai dengan kebutuhan Kamu!</p>
            <p class="text-white lg:text-sm md:text-sm text-xs">Ruko Greenland, Batam, Kepulauan Riau,pIndonesia, 26464</p>
            <div class="flex gap-4">
                <div class="flex gap-2">
                    ...
                    <p class="text-white text-sm">cs@Jgaming.com</p>
                </div>
                <div class="flex gap-2">
                    ...
                    <p class="text-white text-sm">6281333686227</p>
                </div>
            </div>
    ...
    <div class="flex justify-center items-center bg-[#3a3c3b] w-full h-full">
        <div class="flex flex-col lg:w-[50%] md:w-[50%] w-[90%] lg:my-8 md:my-8 my-4 h-fit lg:gap-4 md:gap-4 gap-2">
            <div>
                <img src="{{ asset('image/jd.png') }}" alt="" class="lg:h-16 md:h-16 h-12 py-0.5 lg:w-14 md:w-14 w-10 object-cover">
                <p class="text-white lg:text-3xl md:text-3xl text-xl font-bold">Formulir Laporan / Permintaan</p>
                <p class="text-white lg:text-md md:text-md text-sm">Silahkan isi formulir di bawah ini untuk melaporkan masalah yang Kamu alami. Tim kami akan segera menindaklanjuti laporan Kamu.</p>
            </div>
