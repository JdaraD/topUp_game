...
@endif
    <div class="flex lg:w-[82%] md:w-[82%] w-[92%] h-16 justify-center items-center gap-4 mb-1">
        ...
        @endif
        <div name="search-bar" class="flex grow bg-[#52595d] lg:w-263.75 md:w-263.75 w-258 h-9 rounded-lg border border-white/10 shadow-amber-50 items-center px-2 hover:cursor-text gap-2">
    ...
    <div class="flex justify-between items-center lg:w-[82%] md:w-[82%] w-[88%] h-10">
