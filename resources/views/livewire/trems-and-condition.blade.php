<div class="flex flex-col grow gap-4 justify-center items-center w-full h-full lg:mt-27.5 md:mt-27.5 mt-20 select-none">
    <div class="flex flex-col lg:w-[60%] md:w-[70%] w-[90%] lg:my-8 md:my-4 my-2 h-full lg:gap-4 md:gap-2 gap-1">
        <h1 class="text-[#8e7a5c] lg:text-xl md:text-xl text-lg font-semibold">Kebijakan Privasi</h1>
        ...
        <h2 class="text-[#8e7a5c] lg:text-xl md:text-xl text-lg font-semibold mt-4">Informasi yang Kami Kumpulkan</h2>
        <p class="text-white text-justify">
        ...
        <h2 class="text-[#8e7a5c] lg:text-xl md:text-xl text-lg font-semibold mt-4">Penggunaan Informasi</h2>
